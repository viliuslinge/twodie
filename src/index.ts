...
import { BaseObject, IBaseObjectProperties } from "engine/components/objects";

import imagePathname from "../assets/sprites/sprite.png";

const GAME_WIDTH: number = 1500;
const GAME_HEIGHT: number = 900;

interface IHeroProperties extends IBaseObjectProperties {
  sprite: AnimatedSprite<"walk" | "dance">;
}
